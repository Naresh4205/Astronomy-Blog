...
{
    images[i-1].setAttribute("src","../Assets/images/Satelight/"+i+".jpg")
...
//this is for header
var indval=0;
var imagesarr=["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg"]
function inc()
{
    indval++;
    ...
    {
        indval=0;
        document.getElementById("header").style.backgroundImage="url(../Assets/images/Satelight/"+imagesarr[indval]+")"
    }
    else
    {
        document.getElementById("header").style.backgroundImage="url(../Assets/images/Satelight/"+imagesarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../Assets/images/Satelight/'+pic+".jpg"
